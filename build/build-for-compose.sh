...
product_arch="x86_64"
images=(
registry.cdjdgm.com/wrapper/wrapper-single:3.5.43.8-centos
)
...
fun_execute_build_command() {
    ...
    find "${build_home}/${product_name}" -mindepth 2 -type f -exec chmod 644 {} \;
    find "${build_home}/${product_name}" -maxdepth 1 -type f -exec chmod 600 {} \;
    find "${build_home}/${product_name}" -maxdepth 1 -type f -name "*.sh" -exec chmod 700 {} \;
